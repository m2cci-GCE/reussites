...
ReussitePP.e: ${LIB}/libmachine_trace.a Alea.o Tas.o AfficherTas.o PP.o InteractionPP.o ReussitePP.c
	gcc  -g -I${INCL} -o ReussitePP.e ReussitePP.c ${LIB}/graphlib_w.o InteractionPP.o PP.o Tas.o AfficherTas.o Alea.o -L${LIB} -lmachine_trace -L/usr/X11R6/lib -lX11 -lm
