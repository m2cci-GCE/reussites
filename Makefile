...
ReussiteMD.e: ${LIB}/libmachine_trace.a Alea.o Tas.o AfficherTas.o MD.o InteractionMD.o ReussiteMD.c
	gcc  -g -I${INCL} -o ReussiteMD.e ReussiteMD.c ${LIB}/graphlib_w.o InteractionMD.o MD.o Tas.o AfficherTas.o Alea.o -L${LIB} -lmachine_trace -L/usr/X11R6/lib -lX11 -lm

Reussites.e: ${LIB}/libmachine_trace.a Alea.o Tas.o AfficherTas.o R7.o C4.o QLL.o MD.o InteractionToutes.o Reussites.c
	gcc  -g -I${INCL} -o Reussites.e Reussites.c ${LIB}/graphlib_w.o InteractionToutes.o QLL.o C4.o R7.o MD.o Tas.o AfficherTas.o Alea.o -L${LIB} -lmachine_trace -L/usr/X11R6/lib -lX11 -lm
