...
TestTas_1.e: ${LIB}/libmachine_trace.a Alea.o TasComplet.o AfficherTas.o TestTas_1.c
	gcc  -g -I${INCL} -o TestTas_1.e TestTas_1.c TasComplet.o AfficherTas.o Alea.o -L${LIB} -lmachine_trace -L/usr/X11R6/lib -lX11 -lm
